...
SELECT producto.codigo, producto.nombre, codigo_fabricante, fabricante.nombre FROM fabricante INNER JOIN producto ON fabricante.codigo=producto.codigo_fabricante;
